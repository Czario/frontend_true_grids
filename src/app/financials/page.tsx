  ...
  return (
    <div>
      <ButtonGroup variant="contained" aria-label="outlined primary button group">
        <Button onClick={() => setStatementType('incomeStatement')}>Income Statement</Button>
        <Button onClick={() => setStatementType('cashFlow')}>Cashflow Statement</Button>
        <Button onClick={() => setStatementType('balanceSheet')}>Balance Sheet</Button>
      </ButtonGroup>
      ...
      {!loading && !error && data.length === 0 && (
        <Typography>No data available for the selected statement type.</Typography>
      )}
